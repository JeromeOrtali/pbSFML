...
////////////////////////////////////////////////////////////
void sfWindow_getSettings(const sfWindow* window, sfContextSettings* settings)
{
...
////////////////////////////////////////////////////////////
void sfWindow_getSize(const sfWindow* window, unsigned int* x, unsigned int* y )
{
    sfVector2u size = {0, 0};
...
////////////////////////////////////////////////////////////
void sfWindow_setSize(sfWindow* window, unsigned int x, unsigned int y)
{
    CSFML_CALL(window, setSize(sf::Vector2u(x, y)));
}
